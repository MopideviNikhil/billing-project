                    ...
                    </li>
                    {
                        isAdmin && (
                            <>
                                ...
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/category') ? 'fw-bold text-warning' : ''}`} to={"/category"}>Mangage Categories</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className={`nav-link ${isActive('/users') ? 'fw-bold text-warning' : ''}`} to={"/users"}>Mangage Users</Link>
                                </li>
                            </>
                        )
                    }
